...
if errorlevel 1 exit /b 1
"%WIX%\light.exe" -nologo -sval -ext WixUtilExtension -ext WixUIExtension -cultures:tr-tr -out "%~dp0dist\LegacyRun-3.3.0.msi" "%~dp0dist\Installer.wixobj"
if errorlevel 1 exit /b 1
echo MSI hazir: %~dp0dist\LegacyRun-3.3.0.msi
